...
CREATE TABLE Customer (
  ...
  ssn CHAR(11) UNIQUE,  -- Hash and secure SSN before storing
...
GRANT ALL PRIVILEGES ON BankSys.* TO 'banksys'@'localhost' IDENTIFIED BY 'sysknab';  -- Replace with your credentials
FLUSH PRIVILEGES;
