...
/**
 * The AccountRepository class provides methods for interacting with the database
 ...
 * update existing accounts, and delete accounts. The class utilizes the UserRepository
...
public class AccountRepository {
    public static AccountRepository create(UserRepository userRepository,
                                           Connection connection) {
        return new AccountRepository(userRepository, connection);
    }
        ...
        try (var statement = connection.prepareStatement(query)) {
            ...
            try (var resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    var owner = userRepository.getUserOf(ownerString);
    ...
    private AccountRepository(UserRepository userRepository,
                              Connection connection) {
